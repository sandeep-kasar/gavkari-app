...
import com.gavkariapp.activity.CreateDirectoryActivity
...
class SelectImageFragmentDirectory(private val createDirectoryActivity: CreateDirectoryActivity) :
    ...
    private fun checkCameraPermission() {
        ...
        Dexter.withActivity(createDirectoryActivity)
                .withPermissions(
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            createDirectoryActivity.cameraIntent()
                        }
    ...
    private fun checkGalleryPermission() {
        ...
        Dexter.withActivity(createDirectoryActivity)
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        if (report.areAllPermissionsGranted()) {
                            createDirectoryActivity.galleryIntent()
                        }
                        if (report.isAnyPermissionPermanentlyDenied) {
                            Util.showPermissionAlert(context!!,
                                    getString(R.string.message_enable_permission), getString(R.string.app_name))
