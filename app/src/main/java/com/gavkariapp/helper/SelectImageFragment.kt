...
import com.gavkariapp.activity.CreateEventTwoActivity
...
class SelectImageFragment(private val createAdTwoActivity: CreateEventTwoActivity) :
    ...
    private fun checkCameraPermission() {
        ...
        Dexter.withActivity(createAdTwoActivity)
                .withPermissions(
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            createAdTwoActivity.cameraIntent()
                        }
        ...
        Dexter.withActivity(createAdTwoActivity)
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        // check if all permissions are granted
                        if (report.areAllPermissionsGranted()) {
                            createAdTwoActivity.galleryIntent()
                        }
