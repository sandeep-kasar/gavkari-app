...
import com.gavkariapp.activity.EditSaleAdActivity
...
class SelectImageMySaleAdFragment(private val editSaleAdActivity: EditSaleAdActivity) :
    ...
    private fun checkCameraPermission() {
        ...
        Dexter.withActivity(editSaleAdActivity)
                .withPermissions(
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            editSaleAdActivity.cameraIntent()
                        }
        ...
        Dexter.withActivity(editSaleAdActivity)
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        // check if all permissions are granted
                        if (report.areAllPermissionsGranted()) {
                            editSaleAdActivity.galleryIntent()
                        }
