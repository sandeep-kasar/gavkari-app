...
import com.gavkariapp.activity.EditEventActivity
...
class SelectImageFragmentAd(private val editEventActivity: EditEventActivity) : BottomSheetDialogFragment() {
    ...
    private fun checkCameraPermission() {
        ...
        Dexter.withActivity(editEventActivity)
                .withPermissions(
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            editEventActivity.cameraIntent()
                        }
        ...
        Dexter.withActivity(editEventActivity)
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        // check if all permissions are granted
                        if (report.areAllPermissionsGranted()) {
                            editEventActivity.galleryIntent()
                        }
