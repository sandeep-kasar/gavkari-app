...
import com.gavkariapp.activity.CreateSellAdActivity
...
class SelectImageForSaleFragment(private val createSellAdActivity: CreateSellAdActivity) :
    ...
    private fun checkCameraPermission() {
        ...
        Dexter.withActivity(createSellAdActivity)
                .withPermissions(
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            createSellAdActivity.cameraIntent()
                        }
        ...
        Dexter.withActivity(createSellAdActivity)
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        // check if all permissions are granted
                        if (report.areAllPermissionsGranted()) {
                            createSellAdActivity.galleryIntent()
                        }
