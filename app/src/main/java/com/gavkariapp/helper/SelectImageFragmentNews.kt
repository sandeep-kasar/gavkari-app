...
import com.gavkariapp.activity.CreateNewsActivity
...
class SelectImageFragmentNews(private val createNewsActivity: CreateNewsActivity) :
    ...
    private fun checkCameraPermission() {
        ...
        Dexter.withActivity(createNewsActivity)
                .withPermissions(
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            createNewsActivity.cameraIntent()
                        }
        ...
        Dexter.withActivity(createNewsActivity)
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        // check if all permissions are granted
                        if (report.areAllPermissionsGranted()) {
                            createNewsActivity.galleryIntent()
                        }
